...
// LOAD PICS AND SPRITES
    ...
    // game.load.image('ship', '../sprites/xenon2_ship.png');
    // game.load.image('ship', '../sprites/ship.png');
    // game.load.image('ship', '../sprites/player.png');
    // game.load.image('ship', '../sprites/plane.png');
    // game.load.image('ship', '../sprites/advanced_wars_tank.png');
    // game.load.image('ship', '../sprites/car90.png');
    // game.load.image('ship', '../sprites/tinycar.png');

    game.load.image('bullet', '../bullets/bullets.png');
    // game.load.image('bullet', '../bullets/bullet.png');
